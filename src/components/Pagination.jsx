...
export const Pagination = ({prev, next, offSet}) => {
    return (
        <nav className="h-14 w-fit rounded-lg border-background border-2 flex flex-row items-stretch">
            <button disabled={offSet == 1} className="h-full w-12 p-3 border-r-2 border-background text-primary hover:text-primary hover:font-bold hover:bg-[#ff526f2a] disabled:text-background disabled:hover:bg-[#ff526f00]" onClick={prev}>
